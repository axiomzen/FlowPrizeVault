...
access(all) fun testFixedPercentage100Savings() {
    ...
    Test.assertEqual(1.0, details["savingsPercent"]! as! UFix64)
    Test.assertEqual(0.0, details["lotteryPercent"]! as! UFix64)
...
access(all) fun testFixedPercentage100Lottery() {
    ...
    let poolID = createPoolWithDistribution(savings: 0.0, lottery: 1.0, treasury: 0.0)
    
    let details = getPoolDistributionDetails(poolID)
    Test.assertEqual(0.0, details["savingsPercent"]! as! UFix64)
    Test.assertEqual(1.0, details["lotteryPercent"]! as! UFix64)
    Test.assertEqual(0.0, details["treasuryPercent"]! as! UFix64)
}

access(all) fun testFixedPercentage100Treasury() {
    // Create pool with 0% savings, 0% lottery, 100% treasury
    let poolID = createPoolWithDistribution(savings: 0.0, lottery: 0.0, treasury: 1.0)
...
access(all) fun testFixedPercentageEqualSplit() {
    ...
    let poolID = createPoolWithDistribution(savings: 0.34, lottery: 0.33, treasury: 0.33)
    
    let details = getPoolDistributionDetails(poolID)
    Test.assertEqual(0.34, details["savingsPercent"]! as! UFix64)
    Test.assertEqual(0.33, details["lotteryPercent"]! as! UFix64)
...
access(all) fun testFixedPercentageCustomSplit() {
    ...
    let details = getPoolDistributionDetails(poolID)
    Test.assertEqual(0.7, details["savingsPercent"]! as! UFix64)
    Test.assertEqual(0.2, details["lotteryPercent"]! as! UFix64)
...
access(all) fun testFixedPercentageCalculatesCorrectAmounts() {
    ...
    Test.assertEqual(70.0, distribution["savingsAmount"]! as! UFix64)
    Test.assertEqual(20.0, distribution["lotteryAmount"]! as! UFix64)
...
access(all) fun testDistributionWithZeroAmount() {
    ...
    Test.assertEqual(0.0, distribution["savingsAmount"]! as! UFix64)
    Test.assertEqual(0.0, distribution["lotteryAmount"]! as! UFix64)
    Test.assertEqual(0.0, distribution["treasuryAmount"]! as! UFix64)
}

access(all) fun testDistributionWithSmallAmount() {
    let poolID = createPoolWithDistribution(savings: 0.5, lottery: 0.3, treasury: 0.2)
    
    // With 1.0 total: savings = 0.5, lottery = 0.3, treasury = 0.2
    let distribution = calculateDistribution(poolID: poolID, totalAmount: 1.0)
    Test.assertEqual(0.5, distribution["savingsAmount"]! as! UFix64)
    Test.assertEqual(0.3, distribution["lotteryAmount"]! as! UFix64)
...
access(all) fun testDistributionStrategySumNotOneReverts() {
    ...
    let result = createPoolWithDistributionExpectFailure(savings: 0.5, lottery: 0.3, treasury: 0.1)
