...
access(all) contract UniswapV3SwapConnectors {
    ...
    access(all) struct Swapper: DeFiActions.Swapper {
        ...
        access(all) fun swap(quote: {DeFiActions.Quote}?, inVault: @{FungibleToken.Vault}): @{FungibleToken.Vault} {
            log(">>> [INSTRUMENTED] UniswapV3SwapConnectors.swap() CALLED - inBalance: ".concat(inVault.balance.toString()))
        ...
        access(all) fun swapBack(quote: {DeFiActions.Quote}?, residual: @{FungibleToken.Vault}): @{FungibleToken.Vault} {
            log(">>> [INSTRUMENTED] UniswapV3SwapConnectors.swapBack() CALLED - residualBalance: ".concat(residual.balance.toString()))
