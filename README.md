...
PrizeSavings is a prize-linked savings protocol where users deposit tokens to earn guaranteed savings interest while also having chances to win lottery prizes. Users never lose their principal—all prizes come from yield generated by deposits.
...
│  ├──────────────────────────────────────────────────────────────────┤  │
│  │  ┌─────────────────┐  ┌──────────────────┐  ┌─────────────────┐  │  │
│  │  │SavingsDistributor│  │LotteryDistributor│  │TreasuryDistributor│ │  │
...
> 📖 **[Read the full TWAB documentation →](./docs/TWAB.md)**
